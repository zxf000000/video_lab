...
import type { ButtonVariant, ButtonSize } from "@/src/components/ui/button"
...
function AlertDialogOverlay({
  className,
  ...props
}: React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Backdrop> & { className?: string }) {
  return (
...
function AlertDialogContent({
  ...
  size = "default",
  ...props
}: React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Popup> & { className?: string; size?: string }) {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
